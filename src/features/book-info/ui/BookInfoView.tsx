...
export const BookInfoView = ({ status } : BOOK_INFO_VIEW) => {
    ...
    return (
        <article className="relative bg-[#2A2F32] rounded-[10px] select-none [@media(max-width:499px)]:w-[calc(100%-40px)]">
            ...
            <div className="flex flex-wrap justify-between w-[450px] h-[530px] mx-auto py-[40px] px-[40px] overflow-y-auto [@media(max-width:499px)]:block [@media(max-width:499px)]:w-full [@media(max-width:499px)]:px-[10px] [@media(max-width:499px)]:text-center">
                ...
                <dl className="w-full leading-[1.8] mt-[50px] break-keep">
                    ...
                    <dd className="[@media(max-width:499px)]:px-[20px] [@media(max-width:499px)]:text-left">{data?.["description"]}</dd>
                </dl>
            </div>
        </article>
    )
